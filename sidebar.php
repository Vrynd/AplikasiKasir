...
$toko = $DataLogin['toko bu endang'];
$alamat = $DataLogin['alamat'];
$telepon = $DataLogin['telepon'];
$logo = $DataLogin['logo'];
$name = $DataLogin['aplikasikasir']
...
<head>
    ...
    <title><?php echo"Aplikasi Kasir"?></title>
...
<div class="page-wrapper chiller-theme toggled">
  ...
  <nav id="sidebar" class="sidebar-wrapper">
    ...
    © 2022 Developed by - <a target="_blank" rel="noopener noreferrer" href="#">
     Mz Pace</a>
    </div>
  </nav>
  <!-- sidebar-wrapper  -->
