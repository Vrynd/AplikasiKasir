...
?>
    <h1 class="h3 mb-2">Pengaturan Akun</h1>
        <!-- Profile widget -->
            ...
            <form method="post">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 text-right mt-3">
                            <div id="Ada1">
                                <button type="button" class="btn btn-primary px-4" onclick="GetVerif()">Perbarui</button>
                            </div>
                            ...
                            <div class="tengah-tengah px-3">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" name="SimpanEdit" class="btn btn-primary px-3">Perbarui</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="PagePassword" class="tab-pane fade"><br>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 col-md-11 col-lg-7 text-right">
                                <button type="submit" name="UpdatePass" class="btn btn-primary px-4">Perbarui</button>
                            </div>
                        </div>
