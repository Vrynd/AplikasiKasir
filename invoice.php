...
<div class="d-none pt-5 px-5 print-show">
        <div class="text-center mb-5 pt-2">
            <h2 class="mb-3" style="font-size:60px;"><?php echo "TOKO BU ENDANG" ?></h2>
            <h2 class="mb-0"><?php echo $alamat ?></h2>
            <h2 class="mb-4">Telp : <?php echo $telepon ?></h2>
        </div>
        <h2 class="mb-0">Invoice : <?php echo $noinv ?>
    ...
    <div class="row">
        <div class="col-12 py-3 my-3 border-top border-bottom">
            <div class="row">
                <div class="col-5"><h2 class="mb-0 py-1" style="font-weight:700;">Item</h2></div>
