...
<head>
    ...
    <title><?php echo"Login Aplikasi Kasir"?></title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/kasir.png" alt="" width="72" height="72">
      ...
      <button class="btn btn-warning btn-block" name="login" style="font-weight:700;" type="submit">Login</button>
      <p class="mt-3 mb-3 text-light">&copy; 2022 Developed by - <a target="_blank" rel="noopener noreferrer" href="#" class="text-light">
     Mz Pace</a></p>
    </form>
